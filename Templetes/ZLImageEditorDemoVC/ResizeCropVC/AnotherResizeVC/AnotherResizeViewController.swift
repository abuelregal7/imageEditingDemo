//
//  AnotherResizeViewController.swift
//  Templetes
//
...
class AnotherResizeViewController: UIViewController {
    ...
    private func demoOriginal() {
        ...
        guard let originalImageData = originalImage.jpegData(compressionQuality: 1.0) else { return }
    ...
    private func demoWidth() {
        ...
        guard let resizedImageData = resizedImage.jpegData(compressionQuality: 1.0) else { return }
    ...
    private func demoCrop() {
        ...
        guard let croppedImageData = croppedImage.jpegData(compressionQuality: 1.0) else { return }
